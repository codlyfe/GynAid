...
import com.gynassist.backend.repository.MOHLicenseRepository;
...
public class MOHLicenseService {
    ...
    @Cacheable(value = "licenseValidations", unless = "#result != T(com.gynassist.entity.MOHLicense$VerificationStatus).VERIFIED")

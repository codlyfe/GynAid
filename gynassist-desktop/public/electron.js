...
function createTray() {
  ...
  tray.setToolTip('Gynassist - Reproductive Health Companion');
        ...
        { type: 'separator' },
        {
          ...
          click: async () => {
            const result = await dialog.showSaveDialog(mainWindow, {
              defaultPath: 'gynassist-data.json',
              filters: [
    ...
    },
    {
      ...
      submenu: [
        ...
        },
        {
          label: 'Learn More',
          click: () => {
            shell.openExternal('https://gynassist.ug');
          }
        }
      ]
    }
